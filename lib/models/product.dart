...
class Product extends ChangeNotifier {
  ...
  Product({this.id, this.name, this.description, this.sizes, this.images,}){
    images = images ?? [];
    sizes = sizes ?? [];
  }
  ...
  List<Map<String, dynamic>> exportSizedList(){
    ...
    for(final image in images){
      if(!newImages.contains(image)){
        try{
          ...
          debugPrint('Falha ao deletar está imagem! $image');
        }
      }
    }
